...
const ChartTooltipContent = React.forwardRef<HTMLDivElement, React.ComponentProps<typeof ChartTooltip>>(
  ({ active, payload, label, indicator = "dot", ...props }, ref) => {
    return <ChartTooltip ref={ref} active={active} payload={payload} label={label} indicator={indicator} {...props} />
  },
)
...
// Helper to extract the color from payload.
